...
from parseradv_module import AdvParse
...
class SearchEngine:
    ...
    def __init__(self, config=None):
        ...
        self._parser = AdvParse(persondic)
    ...
    def build_index_from_parquet(self, fn):
        ...
        self._indexer.inverted_idx = {key: val for key, val in self._indexer.inverted_idx.items() if val[1] > 1}
    ...
    def search(self, query,k=None):
        ...
        return searcher.search(query,k=k,engine="best")
    def funFacts(self):
        print("the country that appears the most in our corpus is United States")
        print("fun fact about United States: The American Flag Has Had 27 Versions")
        print("the persona that return most in our corpus is Donald Trump")
        print("fun fact about Donald Trump: He does not drink alcohol, a decision that he made after his brother, Fred Jr, died from alcoholism.")
        print("the park we loves that appears the most in our corpus is Disney World")
        print("fun fact about Disney World: It's NOT a Small World After All - Disney World encompasses over 50 square miles.")
        print("fun fact about twitter: 22% of Americans are on Twitter.")
